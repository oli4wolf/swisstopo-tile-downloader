...
<ResourceURL format="image/png" resourceType="tile" template="https://wmts.geo.admin.ch/1.0.0/ch.astra.veloland/default/{Time}/4326/{TileMatrix}/{TileCol}/{TileRow}.png"/>

z,x,y
Lehn: https://wmts10.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/15/17094/11567.png
Chancy: https://wmts10.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/15/16927/11640.png
Martina: https://wmts10.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/15/17337/11540.png
Basel: https://wmts10.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/15/17162/11415.png
chiasso: https://wmts10.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/15/17206/11682.png
x 
Weissenbühl etwa
https://wmts10.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/15/17059/11533.png
'''
...
def initializeAndLaunch(z:int):
    ...
    for y in range(lowerTileY,upperTileY+1,1):
        for x in range(lowerTileX, upperTileX+1,1):
            urls.append("https://wmts3.geo.admin.ch/1.0.0/ch.astra.veloland/default/current/3857/"+str(z)+"/"+str(x)+"/"+str(y)+".png")
    return urls
